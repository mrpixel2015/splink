  ...
  <head>
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(e) {
            ...
            // noty({"text":"Ruangan No. Gaji dan KataLaluan hendaklah diisi terlebih dahulu.","layout":"top","type":"error",
            //     "animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":500,"timeout":2000,"closeButton":true,
            //     "closeOnSelfClick":true,"closeOnSelfOver":false,"modal":true});
        ...
        function showAlert(msg,type){
            noty({"text":msg,"layout":"center","type":type,"animateOpen":{"height":"toggle"},"animateClose":{"height":"toggle"},"speed":500,"timeout":2000,"closeButton":true,"closeOnSelfClick":true,"closeOnSelfOver":false,"modal":true });
        }
...
<?php
    ...
    if(isset($_POST['loginbtn'])){
        ...
        echo "<span class='hidden'>YEHAA</span>";
        $myMsg = "Maklumat telah berjaya dikemaskini.";
        $type = "success";
                                                            
        echo  "<script type='text/javascript'>showAlert('".$myMsg."','".$type."');</script>";
            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
                ...
                <div class="row">                
                    ...
                    <!--
                      ...
                      -->
                      <img src="img/logoth3.png" width="380" height="180" />
                    </div>
                </div>
                
                <div class="panel panel-default" >
                    <div class="panel-heading">
                        <div class="panel-title text-center">TheData - Sistem Laporan Tabung Haji</div>
                    </div>     
        
                    <div class="panel-body" >
        
                        <form name="loginForm" id="loginForm" class="form-horizontal" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                           
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input id="usernametxt" name="usernametxt" type="text" class="form-control" placeholder="Katanama">                                        
                            </div>
        
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                <input id="passwordtxt" name="passwordtxt" type="password" class="form-control" placeholder="Katalaluan">
                            </div>                                                                  
        
                            <div class="form-group">
                                <!-- Button -->
                                <div class="col-sm-12 controls">
                                    <button id="loginbtn" name="loginbtn" type="submit" href="#" class="btn btn-success pull-right"><i class="glyphicon glyphicon-log-in"></i>&nbsp;Log Masuk</button>                          
                                </div>
                            </div>
                    ...
                    <div class="panel-footer" >
                    	<div class="row">
                    		<div class="col-xs-12 text-center">
                    				<span class="text-muted"><small> © Crafted with love by <strong>Alhar</strong> 2016</small></span>
                    		</div>
                    	</div>
                    </div>                     
                </div>  
